...
class standard_form_elements extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('header', 'anotherheader', 'Another Header element');
